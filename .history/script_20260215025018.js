...
document.addEventListener('DOMContentLoaded', function () {
  ...
  animateSkills();
  // Floating dark slide toggle button (bottom right)
  ...
  // Also update floating button if theme is toggled from navbar
  // themeToggle removed from header, so skip event listener
  // On load
  syncDarkSlideBtn();
